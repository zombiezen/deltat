...
create table "entries" (
  ...
  "end_time" text
    check ("end_time" is null or (
      "end_time" regexp '[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]' and
      "end_time" >= "start_time")),
  "scheduled_end_time" text
    check ("scheduled_end_time" is null or (
      "scheduled_end_time" regexp '[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]' and
